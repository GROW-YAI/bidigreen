  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center mb-6">
        ...
        <h3 className="text-lg text-gray-600">Our Production Team</h3>
      </div>
            ...
            <div className="relative w-64 mx-auto group">
              ...
              <div
                className="absolute bottom-0 left-0 w-full bg-white bg-opacity-80 p-2 text-center 
                           transition-colors duration-300 ease-in-out group-hover:bg-orange-500"
              >
                <h2 className="text-xl font-bold text-gray-800 group-hover:text-white">
                  {team.name}
                </h2>
                <p className="text-sm text-orange-500 font-medium group-hover:text-white">
                  {team.title}
                </p>
              </div>
            </div>
